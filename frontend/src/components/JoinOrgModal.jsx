      ...
      >
        <div className="flex shrink-0 items-start justify-between gap-3 border-b border-line-glass p-4 sm:p-6">
          <div className="min-w-0">
            ...
            <h2 id="join-org-title" className="mt-1 text-xl sm:text-2xl font-semibold text-txt-primary">
              Join Organization
            </h2>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="flex flex-1 flex-col overflow-hidden">
          <div className="flex-1 min-h-0 overflow-y-auto p-4 sm:p-6 space-y-4">
            ...
            {successInfo && (
              <p role="status" className="rounded-xl bg-brand-soft p-3 text-xs sm:text-sm font-semibold text-brand">
                {successInfo}
              </p>
            )}

            <div>
              <label htmlFor="join-org-id" className="block text-sm font-medium text-txt-primary">
                Organization ID
              </label>
              <input
                id="join-org-id"
            ...
            <div>
              <label htmlFor="join-org-code" className="block text-sm font-medium text-txt-primary">
                Join Code
              </label>
              <input
                id="join-org-code"
